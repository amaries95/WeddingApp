...
export default function WeddingTimeline () {
    const weddingTimelineList = [
        ...
        { photo: WeddingCake, title: "Tortul", hour: "21:00", description: "Momentul tortului este o pauză plină de bucurie. Artificiile strălucesc, iar zâmbetele se împrăștie în jur. Pregatiți-vă papilele gustative pentru un moment dulce."},
