...
export default function WeddingTimeline () {
    const weddingTimelineList = [
        ...
        { photo: LegalCeremony, title: "Cununia Civilă",hour: "14:00 - Casa parintească a mirelui", description: "Vă invităm să fiți alături de noi atunci când spunem cel mai important DA din viața noastră. De asemeni, cununia civilă va avea loc la resedința familiei Olar. Nu funcționam bine sub presiune, astfel vom avea nevoie de sprijinul apropiaților pentru a ne șopti răspunsul la întrebări."},
        { photo: SpiritualCeremony, title: "Cununia Religioasă", hour: "17:30 - Catedrala Pogorârea Sfântului Duh", description: "Apoi, ușor ne vom îndrepta spre biserică, unde ne vom uni în fața lui Dumnezeu. Vă rugam să ne fiti alături si sa va deschideți inimile pentru noi."},
        { photo: FotoSession, title: "Ședință foto", hour: "17:30", description: "Având în vedere că vrem să păstrăm amintirea acestei zile toată viața, vă invităm la o scurtă ședință foto de după cununia religioasa. Vă rugăm să aveți răbdare și să participați la toate propunerile fotografilor. Vom profita de acest timp și pentru o scurtă revizie tehnică la Dacie."},
