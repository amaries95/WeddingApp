...
export default function WeddingTimeline () {
    const weddingTimelineList = [
        ...
        { photo: Welcome, title: "Recepție Sală Regina Maria", hour: "14:00", description: "Va invităm să savurați toate preparatele zilei și să vă luați papucii de schimb, pentru că ne-ar plăcea să vă vedem cât mai mult pe ringul de dans. Simțiți-vă ca acasă și bucurați-vă de fiecare clipă alături de noi."},
