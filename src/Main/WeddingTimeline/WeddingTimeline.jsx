...
export default function WeddingTimeline () {
    const weddingTimelineList = [
        ...
        { photo: Welcome, title: "Recepție Sală Regina Maria", hour: "14:30", description: "Va invităm să savurați toate preparatele zilei și să vă luați papuci de schimb, pentru că ne-ar plăcea să vă vedem cât mai mult pe ringul de dans. Simțiți-vă ca acasă și bucurați-va de fiecare clipă alături de noi."},
